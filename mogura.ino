 ...
 * @file	mogura.ino
 *
 * @brief	Arduinoでリアルタイムに処理するモグラたたきサンプル
 *
 *			現状では3個のモグラ（＝LED＋プッシュスイッチ）だが、モグラ自体を構造体（クラス）に
 *			落とし込んでいるのでいくらでも増減できるはず。
 *
 *			ピンアサインは
 ...
 *
 * @attention
 * 			中高生向けの教室のサンプルとして使うには抵抗のある内容、というかconstexprやラムダ
 *			式を取り入れてみたArduioとしても少し挑戦的なコードになっている。
 *
 * @author	乾紗凪
 * @since	2019/12/24
 */
